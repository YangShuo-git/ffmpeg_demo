...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/yangshuo/ffmpeg_demo/ffmpeg_build --extra-cflags=-I/home/yangshuo/ffmpeg_demo/ffmpeg_build/include --extra-ldflags=-L/home/yangshuo/ffmpeg_demo/ffmpeg_build/lib --extra-libs='-lpthread -lm' --bindir=/home/yangshuo/ffmpeg/bin --enable-gpl --enable-nonfree --enable-libfdk-aac --enable-libx264 --enable-libx265 --enable-libmp3lame --enable-libopus --enable-libvpx --enable-debug=3 --disable-optimizations --disable-asm --disable-stripping
prefix=/home/yangshuo/ffmpeg_demo/ffmpeg_build
LIBDIR=$(DESTDIR)${prefix}/lib
SHLIBDIR=$(DESTDIR)${prefix}/lib
INCDIR=$(DESTDIR)${prefix}/include
BINDIR=$(DESTDIR)/home/yangshuo/ffmpeg/bin
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/yangshuo/ffmpeg_demo/ffmpeg_build/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-lvpx -lm -lvpx -lm -lvpx -lm -lvpx -lm -pthread -lm -lz -lfdk-aac -lmp3lame -lm -lopus -lx264 -lx265 -lva
